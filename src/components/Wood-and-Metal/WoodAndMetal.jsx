      ...
      },
      {
        ...
        "itemListElement": filteredProducts.map((product, index) => ({
          ...
          "item": {
            ...
            "description": `Premium ${product.title} for wood and metal surfaces by Nippon for durable and vibrant finishes.`,
            "sku": `NIP-WM-${String(product.id).padStart(3, "0")}`,
            ...
            "offers": {
              "@type": "Offer",
              "priceCurrency": "PKR",
              "price": product.id <= 2 ? (product.id === 1 ? "4000" : "3500") : "4500", // Placeholder prices
          ...
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <li className="flex items-center">
              ...
              <span className="text-gray-700 font-medium">
                {activeCategory === "all"
                  ? "Wood & Metal Paints"
                  : sidebarMenus.find((menu) => menu.key === activeCategory)?.title || "Wood & Metal Paints"}
              </span>
            </li>
          </ol>
        </nav>
