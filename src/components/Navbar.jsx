...
<Link href="/" className="flex items-center space-x-2">
  {/* Logo Image */}
  <Image 
    src="/logoal-.png" // Replace with your actual logo path (e.g., /images/logo.png)
          ...
          <nav className="hidden md:flex items-center space-x-8 font-bold">
            ...
            >
              ...
              >
                Nippon
                <svg
                  className={`w-4 h-4 ml-1 ${isNipponProductsOpen ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                            ...
                            <div className="relative aspect-square w-full overflow-hidden rounded-lg">
                              <Image
                                ...
                                className={`object-cover ${
                                  isNipponCategoryActive(category.name) ? "opacity-90" : "group-hover:opacity-75"
                                }`}
            ...
            >
              ...
              >
                Dulux
                <svg
                  className={`w-4 h-4 ml-1 ${isDuluxProductsOpen ? "rotate-180" : ""}`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                          ...
                          >
                            <div className="relative aspect-square w-full overflow-hidden rounded-lg">
                              <Image
                                ...
                                fill
                                className={`object-cover ${
                                  isDuluxCategoryActive(category.name) ? "opacity-90" : "group-hover:opacity-75"
                                }`}
                                sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                              />
                            </div>
        ...
        <div className="px-2 pt-2 pb-4 space-y-1">
          <Link
            ...
            className={`block px-3 py-2 rounded-md text-base font-medium ${
              activeNav === "home" ? "text-blue-900 bg-blue-50" : "text-gray-700 hover:bg-blue-50"
            }`}
          ...
          <Link
            href="/about"
            className={`block px-3 py-2 rounded-md text-base font-medium ${
              activeNav === "about" ? "text-blue-900 bg-blue-50" : "text-gray-700 hover:bg-blue-50"
            }`}
            onClick={() => setIsMobileMenuOpen(false)}
          >
            About
          ...
          <div>
            <button
              ...
              className={`w-full flex justify-between items-center px-3 py-2 rounded-md text-base font-medium ${
                pathname.startsWith("/products") ? "text-blue-900 bg-blue-50" : "text-gray-700 hover:bg-blue-50"
              }`}
            >
              Nippon
              <svg
                className={`w-5 h-5 ${isNipponProductsOpen ? "rotate-180" : ""}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div>
            <button
              ...
              className={`w-full flex justify-between items-center px-3 py-2 rounded-md text-base font-medium ${
                pathname.startsWith("/dulux") ? "text-blue-900 bg-blue-50" : "text-gray-700 hover:bg-blue-50"
              }`}
            >
              Dulux
              <svg
          ...
          <Link
            href="/contact-us"
            className={`block px-3 py-2 rounded-md text-base font-medium ${
              pathname === "/contact-us" ? "text-blue-900 bg-blue-50" : "text-gray-700 hover:bg-blue-50"
            }`}
            onClick={() => setIsMobileMenuOpen(false)}
          >
            Contact Us
